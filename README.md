...
| 🧩 Skill entrypoints | `universal-diagnostic-tutor` plus focused `tutor-*` entrypoints and `/study-plan` / `/learn-anything` style shortcuts |
...
| Skill-pack invocations | 用 `/tutor`、`/learn-anything`、`/study-plan` 等短提示快速表达学习意图 |
