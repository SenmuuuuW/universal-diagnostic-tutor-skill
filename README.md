...
V1.4 是一个 Markdown-only 教学行为 release。它强化下一步教学决策、认知负荷控制、掌握信号解释、解释压缩和错误到干预的映射，同时继续保留 V1.1 节奏、V1.2 学习模式、V1.2.2 数学显示规则、V1.3 自然教师表达和 STEM-first 定位；不新增 source packs、网站、脚本、API、包管理、数据库、持久记忆、真实 RAG / vector database、PDF、课程地图或基础设施。
