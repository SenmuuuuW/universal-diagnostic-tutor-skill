...
V1.1 强化教师式节奏、关键停顿点、自主资源发现、资源编排式教学和本 Skill 相比普通 GPT / Codex 答案的差异。它仍然是 Markdown-only 教学行为更新，不新增网站、脚本、API、包管理、数据库、持久记忆、真实 RAG / vector database、PDF、课程地图或新 source packs。
