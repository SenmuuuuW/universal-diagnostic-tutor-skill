...
这是 Markdown-based behavior layer，不是 backend infrastructure、官方评分系统、题库或隐藏记忆。
...
| Version | Focus |
| --- | --- |
| V1.9.x | Practice & Mastery Loop: targeted practice, qualitative grading, mistake repair, and readiness |
