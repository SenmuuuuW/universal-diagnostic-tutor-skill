...
如果你的目标很大，Tutor 可能会先帮你确认方向，而不是马上开始乱讲。
...
```text
我先确认一下：你是想为了做项目入门机器学习，当前数学基础比较弱，所以我们先从线性代数和函数/导数开始，而不是直接学神经网络。对吗？
```

确认后，它应该给一个很小的知识地图，再选第一步开始。重点不是一次生成完整课程，而是先找到最值得学的下一步。

如果你要学习计划，尽量让它先说清楚“哪些学科的哪些部分”。
...
## 9. Codex / Claude Code-style agent 怎么用？
